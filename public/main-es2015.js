...
const currencyNames = __webpack_require__(/*! src/config/currency */ "./src/config/currency.js");
let ConverterComponent = class ConverterComponent {
    constructor(converterService) {
        ...
        this.baseNumberSubscription = this.converterService.getUserInput()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])()).subscribe((number) => {
            this.base = number;
            this.updateValues();
        });
    }
...
let CurrencyAdderComponent = class CurrencyAdderComponent {
    constructor() {
...
let CurrencyInfoComponent = class CurrencyInfoComponent {
    constructor() {
...
let CurrencyInputComponent = class CurrencyInputComponent {
    constructor(converterService) {
        this.converterService = converterService;
